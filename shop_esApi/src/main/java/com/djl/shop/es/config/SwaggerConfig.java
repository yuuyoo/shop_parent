package com.djl.shop.es.config;
...
public class SwaggerConfig {
    ...
    public ApiInfo createA(){
        ApiInfo info=new ApiInfoBuilder().title("统一搜索平台").
                contact( new Contact("DJL","","yuuyoo@163.com")).
                description("实现搜索功能").build();
        return info;
    }
    /**
     * 创建API应用
    ...
    public Docket createDocket(){
       Docket docket=new Docket(DocumentationType.SWAGGER_2).apiInfo(createA()).select().
               apis(RequestHandlerSelectors.basePackage("com.djl.shop.es.controller")).
               build();
       return docket;
    }
}