package com.djl.shop.payApi;

import com.djl.shop.pay.util.CommonPayUtil;
import com.djl.shop.pay.util.QrCodeUtil;
...
public class PayTest {
    ...
    public void wechatPayTest() {
        String url= null;
        try {
            url = CommonPayUtil.wechatPay("1","测试微信支付","198808080001");
    ...
    public void wechatPayQueryTest() {
        System.out.println(CommonPayUtil.wechatPayQuery("198808080001"));
    }
}
