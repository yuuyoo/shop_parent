package com.djl.shop.shop_api.config;
...
public class SwaggerConfig {
    ...
    public ApiInfo createA(){
        ApiInfo info=new ApiInfoBuilder().title("电商API接口平台").
    ...
    public Docket createDocket(){
        Docket docket=new Docket(DocumentationType.SWAGGER_2).apiInfo(createA()).select().
                apis(RequestHandlerSelectors.basePackage("com.djl.shop.shop_api.controller")).
                build();
        return docket;
    }
}
